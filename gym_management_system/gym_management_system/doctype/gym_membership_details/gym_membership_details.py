...
class GymMembershipDetails(Document):
    ...
    def before_save(self):
        ...
        self.last_date_of_plan = activation_date + \
            datetime.timedelta(days=months_to_add*365/12)

        self.valid_no_of_days = (self.last_date_of_plan - activation_date).days

        self.validity_ends_indays = (
            self.last_date_of_plan - datetime.date.today()).days
